...
<head>
    <title>Popular Links : office</title>
</head>
    ...
    <div class="container-fluid">
        ...
        <div class="col-12 text-center mb-2">
            <ul class="list-inline mb-4" id="portfolio-flters">
                <li class="btn btn-outline-primary m-1 align-items-center  disabled">office</li>
            </ul>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/1.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/Popular/office/1.jpg" target="_blank"
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/2.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/2.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/3.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/3.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/4.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/4.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/5.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/5.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/6.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/6.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/7.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/7.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/8.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/8.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-10 p-1 py-1 portfolio-item first">
                <div class="position-relative overflow-hidden">
                    <div class=" d-flex align-items-center justify-content-center">
                        <img src="../static/Images/popular/office/9.jpg" alt="" height="300" width="400" />
                    </div>
                    <div
                        class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                        <a class="btn btn-outline-light m-1" href="../static/Images/popular/office/9.jpg" target="_blank"
                            data-lightbox="project">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
